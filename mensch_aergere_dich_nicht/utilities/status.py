...
class TurnStatus(Enum):
    ...
    SELECT_FIGURE =  {"text":"Du hast X Figuren zur Auswahl. Zeige die Nummer der Figur mit einer Hand an und bestaetige mit einem Daumen hoch!", "back": True, "continue": True, "quit": True}
