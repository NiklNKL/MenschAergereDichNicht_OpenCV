...
export declare class LocalOutlierFactor {
     ...
     */
    decision_function(opts: LocalOutlierFactorDecisionFunctionOptions): Promise<NDArray>;
    /**
     ...
     */
    fit_predict(opts: LocalOutlierFactorFitPredictOptions): Promise<NDArray>;
    /**
      Find the K-neighbors of a point.
  
      Returns indices of and distances to the neighbors of each point.
     */
    kneighbors(opts: LocalOutlierFactorKneighborsOptions): Promise<NDArray[]>;
    /**
     ...
     */
    predict(opts: LocalOutlierFactorPredictOptions): Promise<NDArray>;
    /**
     ...
     */
    score_samples(opts: LocalOutlierFactorScoreSamplesOptions): Promise<NDArray>;
    /**
