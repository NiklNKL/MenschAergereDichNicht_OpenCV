...
export declare class HalvingRandomSearchCV {
     ...
     */
    decision_function(opts: HalvingRandomSearchCVDecisionFunctionOptions): Promise<NDArray>;
    /**
     ...
     */
    inverse_transform(opts: HalvingRandomSearchCVInverseTransformOptions): Promise<NDArray | SparseMatrix[]>;
    /**
      Call predict on the estimator with the best found parameters.
  
      Only available if refit=True and the underlying estimator supports predict.
     */
    predict(opts: HalvingRandomSearchCVPredictOptions): Promise<NDArray>;
    /**
      Call predict_log_proba on the estimator with the best found parameters.
  
      Only available if refit=True and the underlying estimator supports predict_log_proba.
     */
    predict_log_proba(opts: HalvingRandomSearchCVPredictLogProbaOptions): Promise<NDArray>;
    /**
      Call predict_proba on the estimator with the best found parameters.
  
      Only available if refit=True and the underlying estimator supports predict_proba.
     */
    predict_proba(opts: HalvingRandomSearchCVPredictProbaOptions): Promise<NDArray>;
    /**
     ...
     */
    score_samples(opts: HalvingRandomSearchCVScoreSamplesOptions): Promise<NDArray>;
    /**
      Call transform on the estimator with the best found parameters.
  
      Only available if the underlying estimator supports transform and refit=True.
     */
    transform(opts: HalvingRandomSearchCVTransformOptions): Promise<NDArray | SparseMatrix[]>;
    /**
