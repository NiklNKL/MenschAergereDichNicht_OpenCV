...
export declare class TruncatedSVD {
     ...
     */
    fit_transform(opts: TruncatedSVDFitTransformOptions): Promise<NDArray[]>;
    /**
     ...
     */
    inverse_transform(opts: TruncatedSVDInverseTransformOptions): Promise<NDArray[]>;
    /**
     ...
     */
    transform(opts: TruncatedSVDTransformOptions): Promise<NDArray[]>;
    /**
