...
export declare class NMF {
     ...
     */
    fit_transform(opts: NMFFitTransformOptions): Promise<NDArray[]>;
    /**
     ...
     */
    inverse_transform(opts: NMFInverseTransformOptions): Promise<NDArray | SparseMatrix[]>;
    /**
     ...
     */
    transform(opts: NMFTransformOptions): Promise<NDArray[]>;
    /**
