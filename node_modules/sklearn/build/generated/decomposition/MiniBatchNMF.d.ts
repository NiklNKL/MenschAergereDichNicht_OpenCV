...
export declare class MiniBatchNMF {
     ...
     */
    fit_transform(opts: MiniBatchNMFFitTransformOptions): Promise<NDArray[]>;
    /**
     ...
     */
    inverse_transform(opts: MiniBatchNMFInverseTransformOptions): Promise<NDArray | SparseMatrix[]>;
    /**
     ...
     */
    transform(opts: MiniBatchNMFTransformOptions): Promise<NDArray[]>;
    /**
