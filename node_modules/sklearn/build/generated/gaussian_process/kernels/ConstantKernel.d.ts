 ...
 */
export declare class ConstantKernel {
    id: string;
    opts: any;
    _py: PythonBridge;
     ...
     */
    __call__(opts: ConstantKernelCallOptions): Promise<NDArray[]>;
    /**
     ...
     */
    diag(opts: ConstantKernelDiagOptions): Promise<NDArray>;
    /**
...
//# sourceMappingURL=ConstantKernel.d.ts.map