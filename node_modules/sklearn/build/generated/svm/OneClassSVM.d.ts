...
export declare class OneClassSVM {
     ...
     */
    decision_function(opts: OneClassSVMDecisionFunctionOptions): Promise<NDArray>;
    /**
     ...
     */
    fit_predict(opts: OneClassSVMFitPredictOptions): Promise<NDArray>;
    /**
      Perform classification on samples in X.
  
      For a one-class model, +1 or -1 is returned.
     */
    predict(opts: OneClassSVMPredictOptions): Promise<NDArray>;
    /**
      Raw scoring function of the samples.
     */
    score_samples(opts: OneClassSVMScoreSamplesOptions): Promise<NDArray>;
    /**
