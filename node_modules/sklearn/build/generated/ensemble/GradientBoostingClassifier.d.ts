...
export declare class GradientBoostingClassifier {
     ...
     */
    decision_function(opts: GradientBoostingClassifierDecisionFunctionOptions): Promise<NDArray[]>;
    /**
    ...
    /**
      Predict class for X.
     */
    predict(opts: GradientBoostingClassifierPredictOptions): Promise<NDArray>;
    /**
      Predict class log-probabilities for X.
     */
    predict_log_proba(opts: GradientBoostingClassifierPredictLogProbaOptions): Promise<NDArray[]>;
    /**
      Predict class probabilities for X.
     */
    predict_proba(opts: GradientBoostingClassifierPredictProbaOptions): Promise<NDArray[]>;
    /**
