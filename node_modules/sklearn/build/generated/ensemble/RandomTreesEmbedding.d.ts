...
export declare class RandomTreesEmbedding {
     ...
     */
    apply(opts: RandomTreesEmbeddingApplyOptions): Promise<NDArray[]>;
    /**
      Return the decision path in the forest.
     */
    decision_path(opts: RandomTreesEmbeddingDecisionPathOptions): Promise<SparseMatrix[]>;
    /**
      Fit estimator.
     */
     ...
     */
    fit_transform(opts: RandomTreesEmbeddingFitTransformOptions): Promise<SparseMatrix[]>;
    /**
    ...
    /**
      Transform dataset.
     */
    transform(opts: RandomTreesEmbeddingTransformOptions): Promise<SparseMatrix[]>;
    /**
