...
export declare class BisectingKMeans {
     ...
     */
    fit_predict(opts: BisectingKMeansFitPredictOptions): Promise<NDArray>;
    /**
      Compute clustering and transform X to cluster-distance space.
  
      Equivalent to fit(X).transform(X), but more efficiently implemented.
     */
    fit_transform(opts: BisectingKMeansFitTransformOptions): Promise<NDArray[]>;
    /**
     ...
     */
    predict(opts: BisectingKMeansPredictOptions): Promise<NDArray>;
    /**
     ...
     */
    transform(opts: BisectingKMeansTransformOptions): Promise<NDArray[]>;
    /**
