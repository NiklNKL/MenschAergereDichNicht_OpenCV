...
export declare class KMeans {
     ...
     */
    fit_predict(opts: KMeansFitPredictOptions): Promise<NDArray>;
    /**
      Compute clustering and transform X to cluster-distance space.
  
      Equivalent to fit(X).transform(X), but more efficiently implemented.
     */
    fit_transform(opts: KMeansFitTransformOptions): Promise<NDArray[]>;
    /**
     ...
     */
    predict(opts: KMeansPredictOptions): Promise<NDArray>;
    /**
     ...
     */
    transform(opts: KMeansTransformOptions): Promise<NDArray[]>;
    /**
