...
export declare class SparseRandomProjection {
     ...
     */
    inverse_transform(opts: SparseRandomProjectionInverseTransformOptions): Promise<NDArray[]>;
    /**
     ...
     */
    transform(opts: SparseRandomProjectionTransformOptions): Promise<NDArray | SparseMatrix[]>;
    /**
